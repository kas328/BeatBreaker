...
namespace OVR
{
	public class TestScript : MonoBehaviour
	{
		...
		[SerializeField] private Transform box1 = null;
		[SerializeField] private Transform box2 = null;

		// Use this for initialization
		void Start()
		{
			testSound1.PlaySoundAt(box1.position);
			testSound2.PlaySoundAt(box2.position);
		}
